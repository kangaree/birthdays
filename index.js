...
function longMonthAndDate(date) {
  return date.toLocaleDateString("en-US", { month: "long", day: "numeric" });
}

// Example usage:
const date = new Date(); // You can pass any valid Date object here
const longMonthAndDay = longMonthAndDate(date);
console.log(longMonthAndDay); // Output will vary based on the current date

const birthday = birthdays[longMonthAndDay];

const heading = document.getElementById("heading");
heading.textContent = birthday.name;
...
// Example usage:
const birthDateString = birthday.birthday;
console.log(getBirthdaySuffix(birthDateString)); // Output: 34th birthday

const xth = document.getElementById("xth");
xth.textContent = getBirthdaySuffix(birthDateString);

// https://codepen.io/codribble/pen/gOQmqJb
